      ...
      <div className="container mx-auto">
        ...
        <div>
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-2   md:grid-cols-3  lg:grid-cols-3 2xl:grid-cols-4 gap-3 px-3  lg:gap-3 w-full md:max-w-5xl lg:max-w-7xl mx-auto justify-center items-center">
